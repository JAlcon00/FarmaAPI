...
public class JsonResponse {
    ...
    /**
     * Enviar respuesta JSON de error de autorización (401)
     */
    public static void unauthorized(HttpServletResponse response, String message) throws IOException {
        error(response, HttpServletResponse.SC_UNAUTHORIZED, message);
    }
    
    /**
     * Enviar respuesta JSON de error de permisos (403)
     */
    public static void forbidden(HttpServletResponse response, String message) throws IOException {
        error(response, HttpServletResponse.SC_FORBIDDEN, message);
    }
    
    /**
     * Enviar respuesta JSON de error de rate limit excedido (429)
     */
    public static void tooManyRequests(HttpServletResponse response, String message) throws IOException {
        error(response, 429, message); // 429 Too Many Requests
    }
